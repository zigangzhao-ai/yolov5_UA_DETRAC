...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default="/home/lj/zzg/fenghuo-zzg/yolov5_zq_DETRAC/runs/train/exp/weights/best.pt", help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/DETRAC.yaml', help='*.data path')
